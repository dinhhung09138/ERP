...
namespace Database.Sql.ERP.Migrations
{
    ...
    [Migration("20201221234009_version-1_0_21")]
    partial class version1_0_21
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.Common.CommonCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.Common.CommonCodeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.EmployeeBank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.EmployeeDependency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HR_EmployeeDependency");
                });
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.EmployeeLeave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HR_EmployeeLeave");
                });

            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.EmployeeLeaveConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HR_EmployeeLeaveConfiguration");
                });

            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.EmployeeLeaveStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HR_EmployeeLeaveStatus");
                });
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.LeaveStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HR_LeaveStatus");
                });

            modelBuilder.Entity("Database.Sql.ERP.Entities.HR.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Sql.ERP.Entities.Security.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = 1,
                            CreateDate = new DateTime(2020, 12, 22, 6, 40, 8, 277, DateTimeKind.Local).AddTicks(9580),
                            Deleted = false,
                            Description = "Sys",
                            IsActive = true,
                            Name = "Sys"
