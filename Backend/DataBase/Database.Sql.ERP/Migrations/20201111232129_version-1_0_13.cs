...
{
    public partial class version1_0_13 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HR_Bank", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HR_EmployeeBank",
                schema: "dbo",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HR_EmployeeBank", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "HR_CONF_BANK", "", "HR", "BANK", "HR_CONFIGURATION", 1, "/configuration/bank" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 150, "GetList", "Bank", "HR_CONF_BANK", true, "HR", "VIEW", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 151, "Insert", "Bank", "HR_CONF_BANK", "HR", "INSERT", 2 },
                    { 152, "Update", "Bank", "HR_CONF_BANK", "HR", "UPDATE", 3 },
                    { 153, "Delete", "Bank", "HR_CONF_BANK", "HR", "DELETE", 4 }
                });
        }
