...
{
    public partial class version1_0_3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "HR_CONF_APPROVE_ST", "", "HR", "APPROVE_STATUS", "HR_CONFIGURATION", 14, "/configuration/approve-status" });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2020, 9, 29, 6, 48, 42, 869, DateTimeKind.Local).AddTicks(6194), true });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Security_FunctionCommand",
                columns: new[] { "Id", "ActionName", "ControllerName", "FunctionCode", "IsView", "ModuleName", "Name", "Precedence" },
                values: new object[] { 88, "GetList", "ApproveStatus", "HR_CONF_APPROVE_ST", true, "HR", "VIEW", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 89, "Insert", "ApproveStatus", "HR_CONF_APPROVE_ST", "HR", "INSERT", 2 },
                    { 90, "Update", "ApproveStatus", "HR_CONF_APPROVE_ST", "HR", "UPDATE", 3 },
                    { 91, "Delete", "ApproveStatus", "HR_CONF_APPROVE_ST", "HR", "DELETE", 4 }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "CreateDate", "IsActive" },
                values: new object[] { new DateTime(2020, 9, 11, 20, 43, 51, 842, DateTimeKind.Local).AddTicks(228), true });
        }
    }
}
