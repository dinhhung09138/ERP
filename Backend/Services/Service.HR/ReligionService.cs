...
namespace Service.HR
{
    public class ReligionService : IReligionService
    {
        ...
        public ReligionService(IERPUnitOfWork context)
        {
            _context = context;
        }
        ...
        private async Task<ResponseModel> Insert(ReligionModel model)
        {
            ResponseModel response = new ResponseModel();
        ...
        private async Task<ResponseModel> Update(ReligionModel model)
        {
            ResponseModel response = new ResponseModel();
        ...
        private async Task<ResponseModel> Delete(ReligionModel model)
        {
            ResponseModel response = new ResponseModel();
