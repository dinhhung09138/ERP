...
namespace Service.Training
{
    public class AppraiseQuestionService : IAppraiseQuestionService
    {
        ...
        public AppraiseQuestionService(ITrainingUnitOfWork context)
        {
            _context = context;
        }
        ...
        private async Task<ResponseModel> Insert(AppraiseQuestionModel model)
        {
            ResponseModel response = new ResponseModel();
        ...
        private async Task<ResponseModel> Update(AppraiseQuestionModel model)
        {
            ResponseModel response = new ResponseModel();
        ...
        private async Task<ResponseModel> Delete(AppraiseQuestionModel model)
        {
            ResponseModel response = new ResponseModel();
