...
export class MajorService {
  ...
  url = {
    ...
    update: APIUrlConstants.commonApi + 'major/update',
    delete: APIUrlConstants.commonApi + 'major/delete',
  };
  ...
  save(model: MajorViewModel, action: FormActionStatus): Observable<ResponseModel> {
