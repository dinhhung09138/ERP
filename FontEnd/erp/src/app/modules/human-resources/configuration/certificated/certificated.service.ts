...
export class CertificatedService {
  ...
  url = {
    ...
    update: APIUrlConstants.commonApi + 'certificated/update',
    delete: APIUrlConstants.commonApi + 'certificated/delete',
  };
  ...
  save(model: CertificatedViewModel, action: FormActionStatus): Observable<ResponseModel> {
