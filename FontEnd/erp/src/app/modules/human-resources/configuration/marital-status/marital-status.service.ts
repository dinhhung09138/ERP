...
export class MaritalStatusService {
  ...
  url = {
    ...
    update: APIUrlConstants.commonApi + 'marital-status/update',
    delete: APIUrlConstants.commonApi + 'marital-status/delete',
  };
  ...
  save(model: MaritalStatusViewModel, action: FormActionStatus): Observable<ResponseModel> {
