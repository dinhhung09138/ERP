...
import { LeaveStatusViewModel } from './status.model';
...
export class LeaveStatusService {
  ...
  url = {
    list: APIUrlConstants.hrApi + 'leave-status/list',
    item: APIUrlConstants.hrApi + 'leave-status/item',
    insert: APIUrlConstants.hrApi + 'leave-status/insert',
    update: APIUrlConstants.hrApi + 'leave-status/update',
    delete: APIUrlConstants.hrApi + 'leave-status/delete',
  };
  ...
  save(model: LeaveStatusViewModel, action: FormActionStatus): Observable<ResponseModel> {
