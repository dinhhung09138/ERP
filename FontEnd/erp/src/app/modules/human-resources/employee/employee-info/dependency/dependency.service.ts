...
export class EmployeeDependencyService {
  ...
  url = {
    list: APIUrlConstants.hrApi + 'employee-dependency/list',
    item: APIUrlConstants.hrApi + 'employee-dependency/item',
    insert: APIUrlConstants.hrApi + 'employee-dependency/insert',
    update: APIUrlConstants.hrApi + 'employee-dependency/update',
    delete: APIUrlConstants.hrApi + 'employee-dependency/delete',
  };
  ...
  save(model: EmployeeDependencyViewModel, action: FormActionStatus): Observable<ResponseModel> {
