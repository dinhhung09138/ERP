...
export class EmployeeService {
  ...
  dependencyFunctionCode = 'HR_EMPLOYEE_DEPENDENCY';
  url = {
  ...
  constructor(
    ...
    getDependencyPermission(): PermissionViewModel {
      return this.context.getPermissionByForm(this.moduleName, this.dependencyFunctionCode);
    }
