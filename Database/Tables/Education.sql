...
GO
ALTER TABLE [dbo].[Education] ADD  CONSTRAINT [DF_Education_CreateDate]  DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [dbo].[Education] ADD  CONSTRAINT [DF_Education_Deleted]  DEFAULT ((0)) FOR [Deleted]
GO